...
export type KYCTargetType = 'landlord' | 'sale';
export type KYCStatus = 'pending' | 'verified' | 'rejected' | 'resubmit_required';

export interface KYCVerification {
  id: string;
  userId: string;
  targetType: KYCTargetType;
  landlordId?: string;
  companyId?: string;
  fullName: string;
  idCardNumber: string;
  ...
  frontCardUrl: string;
  backCardUrl: string;
  selfieUrl: string; // Ảnh 3D / Chân dung người thực
  ownershipDocumentUrl?: string; // Giấy tờ sở hữu/ủy quyền BDS dành cho Chủ nhà
  status: KYCStatus;
