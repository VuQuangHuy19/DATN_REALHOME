...
const HANOI_LANDMARKS: Record<string, GeoCoordinates> = {
  ...
  'yên hoà': { lat: 21.0244, lng: 105.7938, displayName: 'Phường Yên Hòa, Cầu Giấy, Hà Nội' },
  'yen hoa': { lat: 21.0244, lng: 105.7938, displayName: 'Phường Yên Hòa, Cầu Giấy, Hà Nội' },
  'giáp nhất': { lat: 21.0061, lng: 105.8115, displayName: 'Đường Giáp Nhất, Đống Đa, Hà Nội' },
  'giap nhat': { lat: 21.0061, lng: 105.8115, displayName: 'Đường Giáp Nhất, Đống Đa, Hà Nội' },
  'pháo đài láng': { lat: 21.0189, lng: 105.8078, displayName: 'Phố Pháo Đài Láng, Đống Đa, Hà Nội' },
  'phao dai lang': { lat: 21.0189, lng: 105.8078, displayName: 'Phố Pháo Đài Láng, Đống Đa, Hà Nội' },
  'đường láng': { lat: 21.0165, lng: 105.8080, displayName: 'Đường Láng, Đống Đa, Hà Nội' },
  'duong lang': { lat: 21.0165, lng: 105.8080, displayName: 'Đường Láng, Đống Đa, Hà Nội' },
  'nguyễn chí thanh': { lat: 21.0229, lng: 105.8086, displayName: 'Đường Nguyễn Chí Thanh, Đống Đa, Hà Nội' },
  'nguyen chi thanh': { lat: 21.0229, lng: 105.8086, displayName: 'Đường Nguyễn Chí Thanh, Đống Đa, Hà Nội' },
  'trần duy hưng': { lat: 21.0084, lng: 105.7946, displayName: 'Đường Trần Duy Hưng, Cầu Giấy, Hà Nội' },
  'tran duy hung': { lat: 21.0084, lng: 105.7946, displayName: 'Đường Trần Duy Hưng, Cầu Giấy, Hà Nội' },
  'nguyễn khánh toàn': { lat: 21.0378, lng: 105.7981, displayName: 'Đường Nguyễn Khánh Toàn, Cầu Giấy, Hà Nội' },
  'nguyen khanh toan': { lat: 21.0378, lng: 105.7981, displayName: 'Đường Nguyễn Khánh Toàn, Cầu Giấy, Hà Nội' },
  'thái thịnh': { lat: 21.0105, lng: 105.8164, displayName: 'Phố Thái Thịnh, Đống Đa, Hà Nội' },
  'thai thinh': { lat: 21.0105, lng: 105.8164, displayName: 'Phố Thái Thịnh, Đống Đa, Hà Nội' },
  'khâm thiên': { lat: 21.0188, lng: 105.8364, displayName: 'Phố Khâm Thiên, Đống Đa, Hà Nội' },
  'kham thien': { lat: 21.0188, lng: 105.8364, displayName: 'Phố Khâm Thiên, Đống Đa, Hà Nội' },
  'khương trung': { lat: 20.9972, lng: 105.8175, displayName: 'Phố Khương Trung, Thanh Xuân, Hà Nội' },
  'khuong trung': { lat: 20.9972, lng: 105.8175, displayName: 'Phố Khương Trung, Thanh Xuân, Hà Nội' },
  'thái hà': { lat: 21.0128, lng: 105.8189, displayName: 'Phố Thái Hà, Đống Đa, Hà Nội' },
  'thai ha': { lat: 21.0128, lng: 105.8189, displayName: 'Phố Thái Hà, Đống Đa, Hà Nội' },
  'chính kinh': { lat: 21.0012, lng: 105.8105, displayName: 'Phố Chính Kinh, Thanh Xuân, Hà Nội' },
  'chinh kinh': { lat: 21.0012, lng: 105.8105, displayName: 'Phố Chính Kinh, Thanh Xuân, Hà Nội' },
  'định công thượng': { lat: 20.9856, lng: 105.8248, displayName: 'Phố Định Công Thượng, Hoàng Mai, Hà Nội' },
  'dinh cong thuong': { lat: 20.9856, lng: 105.8248, displayName: 'Phố Định Công Thượng, Hoàng Mai, Hà Nội' },
  'hoàng an': { lat: 21.0195, lng: 105.8350, displayName: 'Ngõ Hoàng An, Đống Đa, Hà Nội' },
  'hoang an': { lat: 21.0195, lng: 105.8350, displayName: 'Ngõ Hoàng An, Đống Đa, Hà Nội' },
  'quan nhân': { lat: 21.0042, lng: 105.8089, displayName: 'Phố Quan Nhân, Thanh Xuân, Hà Nội' },
  'quan nhan': { lat: 21.0042, lng: 105.8089, displayName: 'Phố Quan Nhân, Thanh Xuân, Hà Nội' },
  'hạ đình': { lat: 20.9935, lng: 105.8088, displayName: 'Phố Hạ Đình, Thanh Xuân, Hà Nội' },
  'ha dinh': { lat: 20.9935, lng: 105.8088, displayName: 'Phố Hạ Đình, Thanh Xuân, Hà Nội' },
  'nguyễn ngọc nại': { lat: 20.9995, lng: 105.8214, displayName: 'Phố Nguyễn Ngọc Nại, Thanh Xuân, Hà Nội' },
  'nguyen ngoc nai': { lat: 20.9995, lng: 105.8214, displayName: 'Phố Nguyễn Ngọc Nại, Thanh Xuân, Hà Nội' },
  'nguyễn khang': { lat: 21.0210, lng: 105.7995, displayName: 'Đường Nguyễn Khang, Cầu Giấy, Hà Nội' },
  'nguyen khang': { lat: 21.0210, lng: 105.7995, displayName: 'Đường Nguyễn Khang, Cầu Giấy, Hà Nội' },
  'vương thừa vũ': { lat: 21.0005, lng: 105.8220, displayName: 'Phố Vương Thừa Vũ, Thanh Xuân, Hà Nội' },
  'vuong thua vu': { lat: 21.0005, lng: 105.8220, displayName: 'Phố Vương Thừa Vũ, Thanh Xuân, Hà Nội' },
  'giáp nhị': { lat: 20.9743, lng: 105.8454, displayName: 'Phố Giáp Nhị, Hoàng Mai, Hà Nội' },
  'giap nhi': { lat: 20.9743, lng: 105.8454, displayName: 'Phố Giáp Nhị, Hoàng Mai, Hà Nội' },
  'mễ trì thượng': { lat: 21.0061, lng: 105.7765, displayName: 'Phố Mễ Trì Thượng, Nam Từ Liêm, Hà Nội' },
  'me tri thuong': { lat: 21.0061, lng: 105.7765, displayName: 'Phố Mễ Trì Thượng, Nam Từ Liêm, Hà Nội' },
  'hoàng ngân': { lat: 21.0092, lng: 105.8055, displayName: 'Phố Hoàng Ngân, Cầu Giấy, Hà Nội' },
  'hoang ngan': { lat: 21.0092, lng: 105.8055, displayName: 'Phố Hoàng Ngân, Cầu Giấy, Hà Nội' },
